...
/* the source sprite: a small cool-white core bleeding to a pale sage edge
   (recoloured to sit in the sage-gray palette — same radial sprite, same
   physics). Original stops: 0 rgba(255,255,255,1),
...
function makeSprite() {
  ...
  grad.addColorStop(0, "rgba(238,244,236,1)");
  grad.addColorStop(0.35, "rgba(176,196,178,0.5)");
  grad.addColorStop(1, "rgba(176,196,178,0)");
  g.fillStyle = grad;
  g.fillRect(0, 0, s, s);
  return c;
}
